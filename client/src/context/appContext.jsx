...
const AppProvider = ({ children }) => {
  ...
  const getCoins = async () => {
    ...
    try {
      ...
      dispatch({ type: GET_COINS_SUCCESS, payload: data.list });
    } catch (error) {
  ...
  const getFavList = async () => {
    ...
    try {
      ...
      dispatch({ type: GET_FAV_LIST_SUCCESS, payload: data.favList });
    } catch (error) {
      dispatch({ type: API_CALL_FAIL });
    }
  };
  const addToFav = async (coinId) => {
    ...
    try {
      ...
      // console.log(data.list);
      dispatch({ type: AAD_FAV_SUCCESS, payload: data.favList });
    } catch (error) {
      dispatch({ type: API_CALL_FAIL });
    }
  };
  ...
  const removeFromFav = async (coinId) => {
    ...
    try {
      ...
      // console.log(data.list);
      dispatch({ type: REMOVE_FAV_SUCCESS, payload: data.favList });
    } catch (error) {
      dispatch({ type: API_CALL_FAIL });
    }
  };
  ...
  const changeRole = async (userId, userRole) => {
    ...
    try {
      ...
      dispatch({ type: CHANGE_ROLE__SUCCESS, payload: data.users });
  ...
  const deleteUser = async (userId) => {
    ...
    try {
      ...
      dispatch({ type: DELETE_USER_SUCCESS, payload: data.users });
